                    ...
                    [
                        {
                            ...
                            "details": PoolDetails(name=cast("str", pool_name)),
                        }
                        for pool_name in action.entities
                    ]
                )
            else:
                requests.extend(
            ...
            if action.action == BulkAction.DELETE:
                requests.extend(
                    [
                        {
                            "method": MAP_BULK_ACTION_TO_AUTH_METHOD[action.action],
                            "details": ConnectionDetails(conn_id=cast("str", connection_id)),
                        }
                        for connection_id in action.entities
                    ]
                )
            else:
                requests.extend(
                    [
                        {
                            "method": MAP_BULK_ACTION_TO_AUTH_METHOD[action.action],
                            "details": ConnectionDetails(conn_id=connection.connection_id),
                        }
            ...
            if action.action == BulkAction.DELETE:
                requests.extend(
                    [
                        {
                            "method": MAP_BULK_ACTION_TO_AUTH_METHOD[action.action],
                            "details": VariableDetails(key=cast("str", variable_key)),
                        }
